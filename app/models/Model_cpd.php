...
class Model_template
{
    ...
    public function cpdHapus($data){
     // tulis perintah insert
     $sql = "DELETE FROM cpd set nama = :nama ,	sandi = :md5sandi	, jkel = :jnkel	, tplahir	= :tplahir , tglahir = :tglahir ,	sd = :npsnsd	, smp = :npsnsmp ,	nbin = :nbin ,	nmat = :nmat ,	nipa	= :nipa , alamat = :alamat ,WHERE nisn = :nisn";
